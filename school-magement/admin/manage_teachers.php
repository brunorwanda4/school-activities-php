...
<body class="bg-gray-100 min-h-screen flex flex-col items-center py-10">
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl">
        <h2 class="text-2xl font-bold text-center text-violet-600 mb-4">Teachers List</h2>
        <a href="add_teacher.php" class="mb-4 inline-block bg-violet-500 hover:bg-violet-600 text-white font-bold py-2 px-4 rounded">Add New Teacher</a>
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="p-2 text-center">
                        ...
                        <a href="delete_teacher.php?id=<?php echo $row['id']; ?>" class="text-red-500 hover:underline" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
