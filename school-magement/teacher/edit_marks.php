    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
        ...
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input id="student_id" type="text" name="student_id" value="<?php echo $marks['student_id']; ?>" required class="w-full border p-2 rounded focus:ring focus:ring-violet-200">
            </div>

            <div>
                <label for="subject" class="block text-gray-700 font-medium">Subject</label>
                <input id="subject" type="text" name="subject" value="<?php echo $marks['subject']; ?>" required class="w-full border p-2 rounded focus:ring focus:ring-violet-200">
            </div>

            <div>
                <label for="marks" class="block text-gray-700 font-medium">Marks</label>
                <input id="marks" type="number" name="marks" value="<?php echo $marks['marks']; ?>" required class="w-full border p-2 rounded focus:ring focus:ring-violet-200">
            </div>
