...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    mysqli_query($ineza_conn, "DELETE FROM modules WHERE id='$id'");
    header("Location: manage_modules.php");
    exit();
}

// Fetch all modules
$result = mysqli_query($ineza_conn, "SELECT * FROM modules");
?>
...
<body class="bg-gray-100 p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <?php if (isset($_GET['edit'])) {
            $id = $_GET['edit'];
            $module = mysqli_fetch_assoc(mysqli_query($ineza_conn, "SELECT * FROM modules WHERE id='$id'"));
        ?>
