...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    mysqli_query($ineza_conn, "DELETE FROM students WHERE id='$id'");
    header("Location: manage_students.php");
    exit();
}

// Fetch all students
$result = mysqli_query($ineza_conn, "SELECT * FROM students");
?>
...
<body class="bg-gray-100 p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <?php if (isset($_GET['edit'])) {
            $id = $_GET['edit'];
            $student = mysqli_fetch_assoc(mysqli_query($ineza_conn, "SELECT * FROM students WHERE id='$id'"));
        ?>
